...
definition(
    name: "Keep Me Cozy III",
    namespace: "mattui",
    author: "Matt Klepac",
    description: "Works the same as Keep Me Cozy II, but enables you to alternate reading from the Temperature Sensor or Thermostat based on whether a Door or Window is closed.",
...
preferences() {
	...
	section("Choose temperature sensor... ") {
		input "sensor", "capability.temperatureMeasurement", title: "Temp Sensors"
	}
    section("Choose door or window...") {
