metadata {
	...
	preferences {
		section("Fan Thresholds") {
			input "lowThreshold", "number", title: "Low Threshold", defaultValue: 33, range: "1..99"
			input "medThreshold", "number", title: "Medium Threshold", defaultValue: 66, range: "1..99"
			input "highThreshold", "number", title: "High Threshold", defaultValue: 99, range: "1..99"
		}
	}
}
